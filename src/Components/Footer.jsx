...
const socialLinks = [
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/veloramil",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Facebook",
    href: "https://facebook.com/veloramil",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <ul className="space-y-3">
            ...
            <li>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 mt-1 px-4 py-2 bg-green-600/20 hover:bg-green-600/30 border border-green-700/30 rounded-lg text-xs text-green-400 font-semibold transition-colors"
              >
