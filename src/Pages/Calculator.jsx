    ...
    <main className="bg-white min-h-screen">
      ...
      <div className="bg-gradient-to-br from-green-900 to-green-800 text-white">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-20">
          <span className="text-xs font-bold tracking-widest uppercase text-green-300">Route Planner</span>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 border border-white/20 rounded-xl text-sm text-white backdrop-blur-sm">
              <svg className="w-4 h-4 text-green-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>
            ...
            {config.discountTiers.map((t) => (
              <span key={t.minDeliveries} className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 border border-white/20 rounded-xl text-sm text-white backdrop-blur-sm">
                <svg className="w-4 h-4 text-green-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" /></svg>
        ...
        <div className="grid lg:grid-cols-5 gap-8 items-start">
          ...
          <div className="lg:col-span-2">
              ...
              <div className="p-6 space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      min="0"
                      step="0.1"
                      className={`w-full pl-10 pr-14 py-3.5 rounded-xl border text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 transition ${errors.distance ? "border-red-300 focus:ring-red-200 bg-red-50" : "border-gray-200 focus:ring-green-200 focus:border-green-400"}`}
                    />
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      min="1"
                      step="1"
                      className={`w-full pl-10 pr-4 py-3.5 rounded-xl border text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 transition ${errors.deliveries ? "border-red-300 focus:ring-red-200 bg-red-50" : "border-gray-200 focus:ring-green-200 focus:border-green-400"}`}
                    />
                  </div>
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    ...
                    className="flex-1 py-3.5 bg-green-800 text-white text-sm font-bold rounded-xl hover:bg-green-700 active:bg-green-900 transition-all shadow-lg shadow-green-900/20 disabled:opacity-60 flex items-center justify-center gap-2"
                  >
                    {isCalculating ? (
                      <>
            ...
            <div className="mt-4 bg-green-50 border border-green-100 rounded-2xl p-5">
              <p className="text-xs font-bold text-green-800 uppercase tracking-wide mb-3">Shared Route Discounts</p>
              <div className="space-y-2">
                {config.discountTiers.map((t) => (
                  <div key={t.minDeliveries} className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-bold text-green-800 bg-green-100 px-2.5 py-0.5 rounded-full text-xs">{t.discount}% OFF</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="lg:col-span-3">
            {!result ? (
              ...
              <div className="space-y-4">
                {/* Total Card */}
                <div className="bg-gradient-to-br from-green-900 to-green-800 rounded-2xl p-8 text-white shadow-xl shadow-green-900/20">
                  <div className="flex items-start justify-between mb-6">
                    <div>
                      <p className="text-green-300 text-xs font-bold uppercase tracking-widest">Total Delivery Cost</p>
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-5 border-t border-white/20">
                    <div>
                      <p className="text-green-300 text-xs">Distance</p>
                      <p className="text-white font-bold mt-0.5">{result.distance} km</p>
                    </div>
                    <div>
                      <p className="text-green-300 text-xs">Deliveries</p>
                      <p className="text-white font-bold mt-0.5">{result.deliveries} stops</p>
                    </div>
                    <div>
                      <p className="text-green-300 text-xs">Per Delivery</p>
                    ...
                    {result.discountAmount > 0 && (
                      <div className="flex items-center justify-between p-4 bg-green-50 rounded-xl border border-green-100">
                        <div>
                          ...
                          <p className="text-xs text-green-600 mt-0.5">{result.discountPercent}% off for {result.deliveries} deliveries</p>
                        </div>
                        <span className="text-base font-bold text-green-700">−₹{result.discountAmount.toFixed(2)}</span>
                      </div>
                    )}

                    <div className="flex items-center justify-between p-4 bg-green-900 rounded-xl">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pb-16">
        <div className="bg-gradient-to-br from-green-900 to-green-800 rounded-3xl overflow-hidden">
          <div className="grid md:grid-cols-2">

            {/* Left — context */}
            <div className="p-10 md:p-12 text-white">
              <span className="inline-block text-[10px] font-bold tracking-widest uppercase text-green-300 mb-4">
                Request Coverage
              </span>
              <h2 className="text-2xl md:text-3xl font-bold leading-tight mb-4">
                Ready to start your route?
              </h2>
              <p className="text-green-200 text-[15px] leading-relaxed mb-8">
              ...
              <div className="bg-white/10 border border-white/10 rounded-2xl p-5 space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  <span className="text-green-300">Distance</span>
                  <span className="font-bold text-white">{distance ? `${distance} km` : "—"}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-green-300">Deliveries</span>
            ...
            <div className="p-10 md:p-12 bg-white/5 border-l border-white/5">
              {enquirySubmitted ? (
                ...
                <form onSubmit={handleEnquirySubmit} className="space-y-5">
                  <p className="text-xs font-bold uppercase tracking-widest text-green-300 mb-6">
                    Your Details
                  </p>

                  <div>
                    <label className="block text-xs font-semibold text-green-200 mb-2 uppercase tracking-wide">
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-sm text-white placeholder-green-300/50 focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent transition"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-sm text-green-300 placeholder-green-300/30 cursor-not-allowed"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-semibold text-green-200 mb-2 uppercase tracking-wide">
                      ...
                      <input
                        readOnly
                        value={deliveries}
                        className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-sm text-green-300 cursor-not-allowed"
                      />
                    </div>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3.5 bg-white text-green-900 text-sm font-bold rounded-xl hover:bg-green-50 transition-all flex items-center justify-center gap-2.5 shadow-lg"
                  >
