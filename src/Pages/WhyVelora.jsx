...
const features = [
  ...
  },
  {
    ...
    desc: "Milked at 4:30 AM, tested, packaged, and delivered between 5–7 AM. You drink milk that is literally hours old, not days.",
  },
  {
...
const vsLocalRows = [
  ...
  { label: "Delivery Timing",   them: "Irregular — missed days, no fixed time",                      us: "5:00 AM – 7:00 AM, 365 days (varies by distance)" },
...
function FIcon({ d, d2 }) {
  return (
    <svg className="w-5 h-5 text-green-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.7}>
    ...
    <div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {features.map((f) => (
          <div
            key={f.title}
            className="group bg-white border border-gray-100 rounded-2xl p-7 hover:border-green-200 hover:shadow-lg hover:shadow-green-900/5 transition-all duration-200"
          >
            ...
            <span className="inline-block text-[10px] font-bold tracking-widest uppercase text-green-600 bg-green-50 px-2.5 py-1 rounded-md mb-3">
              {f.stat}
            </span>
      ...
      <div className="mt-10 bg-gradient-to-r from-green-900 to-green-800 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
        ...
        <div className="flex gap-3 flex-shrink-0">
          <Link
            to="/products"
            className="px-6 py-2.5 bg-white text-green-900 text-sm font-bold rounded-xl hover:bg-green-50 transition-all"
          >
            Shop Now
          </Link>
          <Link
            to="/contact"
            className="px-6 py-2.5 border border-green-700 text-white text-sm font-semibold rounded-xl hover:bg-green-800 transition-all"
          >
            Contact Us
          </Link>
        </div>
...
function ComparisonPanel({ competitorName, verdict, rows }) {
  return (
    <div>
      ...
      <div className="overflow-x-auto rounded-2xl border border-gray-200">
        <div className="min-w-[580px]">
          ...
          <div className="grid grid-cols-[160px_1fr_1fr] border-b border-gray-200">
            ...
            <div className="bg-green-900 border-l border-green-800 px-6 py-4 flex items-center gap-2">
              <Check />
              <p className="text-[10px] font-bold uppercase tracking-widest text-green-300">Velora</p>
            </div>
          </div>
      ...
      <div className="mt-8 bg-green-900 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
        ...
        <a
          ...
          className="flex-shrink-0 inline-flex items-center gap-2.5 px-7 py-3 bg-white text-green-900 text-sm font-bold rounded-xl hover:bg-green-50 transition-all whitespace-nowrap"
        >
    ...
    <section className="py-20 md:py-24 bg-gray-50 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="text-center mb-12">
          <span className="text-xs font-bold tracking-widest uppercase text-green-700">Know the Difference</span>
