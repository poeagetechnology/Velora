...
const contactInfo = [
  ...
  {
    icon: <svg className="w-5 h-5 text-blue-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
    label: "Delivery Hours", value: "5:00 AM – 9:00 AM daily",
  },
];
    ...
    <main className="bg-white min-h-screen">
      ...
      <div className="bg-gradient-to-br from-blue-900 to-blue-800 text-white">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-20">
          <span className="text-xs font-bold tracking-widest uppercase text-blue-300">Reach Out</span>
        ...
        <div className="grid md:grid-cols-5 gap-12 lg:gap-16">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="p-5 bg-blue-50 border border-blue-100 rounded-xl">
              <p className="text-sm text-blue-800 font-semibold mb-1">Based in Gobichettipalayam</p>
              ...
              <div className="h-full flex items-center justify-center">
                <div className="text-center py-16 px-8">
                  ...
                  <button
                    ...
                    className="mt-8 px-6 py-2.5 text-sm font-semibold text-blue-800 border border-blue-300 rounded-lg hover:bg-blue-50 transition"
                  >
              ...
              <form onSubmit={handleSubmit} className="bg-gray-50 rounded-2xl border border-gray-100 p-8 space-y-5">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" name="name" value={form.name} onChange={handleChange} placeholder="Ravi Kumar" required
                      className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <select name="subject" value={form.subject} onChange={handleChange}
                    className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                ...
                <div>
                  ...
                  <textarea name="message" value={form.message} onChange={handleChange} rows={4} placeholder="Tell us how we can help…" required
                    className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-none" />
                </div>
