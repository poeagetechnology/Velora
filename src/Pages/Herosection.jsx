...
import HeroImg from "../Asset/Logos.png";
...
export default function Herosection() {
  return (
    <>
      {/* Announcement Banner */}
      <div className="bg-blue-900 text-white text-center py-2.5 px-4">
        <p className="text-sm font-medium">
          <span className="text-blue-300 font-semibold">நம்ம ஊர் பசும்பால், நம்ம வீட்டு ஆரோக்கியம்.</span>
          <span className="mx-3 text-blue-600">·</span>
          <span className="text-white font-semibold">Opening Soon in Gobichettipalayam</span>
        </p>
      </div>
      ...
      <section className="relative bg-white overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute -top-32 -right-32 w-[36rem] h-[36rem] bg-blue-50 rounded-full opacity-50" />
          <div className="absolute bottom-0 -left-20 w-80 h-80 bg-sky-50 rounded-full opacity-40" />
        </div>

        <div className="relative max-w-7xl mx-auto px-4 md:px-8 py-20 md:py-28 grid md:grid-cols-2 gap-12 items-center">

          <div className="text-center md:text-left">
            <span className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-blue-50 border border-blue-100 rounded-full text-xs font-semibold text-blue-700 mb-6">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 leading-[1.08] tracking-tight">
              From Our Farm
              <br />
              <span className="text-blue-800">to Your Family.</span>
            </h1>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
              <Link
                to="/products"
                className="px-7 py-3.5 bg-blue-800 text-white text-sm font-semibold rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-900/20"
              >
                Explore Products
              </Link>
              <Link
            ...
            <div className="mt-8 flex flex-wrap gap-2 justify-center md:justify-start">
              {trustBadges.map((b) => (
                ...
                >
                  <svg className="w-3 h-3 text-blue-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
          ...
          <div className="flex justify-center md:justify-end">
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="w-80 h-80 bg-blue-50 rounded-full" />
              </div>
              ...
              <div className="absolute top-8 -left-6 md:-left-12 hidden sm:flex bg-white rounded-2xl shadow-lg border border-gray-100 px-4 py-3 items-center gap-3 min-w-max">
                <div className="w-9 h-9 bg-blue-900 rounded-xl flex items-center justify-center flex-shrink-0">
                  <svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <div>
                  <p className="text-xs text-gray-400 font-medium">Milked Today</p>
